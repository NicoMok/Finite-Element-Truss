...
% 2nd row: coordinates of node 2: 0,120
% 3rd row: coordinates of node 3: 120,120
% 4th row: coordinates of node 4: 120,0
system.coordinatesOfNodes = [0 0; 0 120; 120 120; 120 0];
...
% 2nd STEP: Initiate the load and displacement vectors and stiffness matrix
% as zero matrices to be filled in later.
...
for element = 1:structure.numberOfElements
    ...
    firstPoint = structure.coordinatesOfNodes(elementNodes(1,1),:)+scaleFactor*[structure.displacements(firstNodedof(1,1),1) structure.displacements(firstNodedof(1,2),1)];
    secondPoint = structure.coordinatesOfNodes(elementNodes(1,2),:)+scaleFactor*[structure.displacements(secondNodedof(1,1),1) structure.displacements(secondNodedof(1,2),1)];
